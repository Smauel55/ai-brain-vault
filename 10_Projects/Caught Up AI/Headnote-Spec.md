...
| **The Reckoning** | The real, datable trigger; the party held responsible; a public moral address. | Public address + real occasion + responsible party. Names a real institution, body, or practice (a corporation, an agency, a council, a documented system), never a named or identifiable politician or a party, and never an implicit side of a national third rail. |
| **The Open Letter** | The speaking role, the more-powerful addressee, and the precipitating event. | Role + addressee (scenario, not a fake name). The addressee may be an institution or body, including a civic body (a city council, Congress, an agency) as well as a company, industry, or standards body, but never a named or identifiable political officeholder, candidate, or party. E.g. *"In the following open letter, a [role] writes to [a city council / an agency / a company] after [event]."* |
...
**Pointed civic pieces vary in published form (per [[Editorial-Standards]] Guardrail 1, civic tier).** Pointed advocacy is not confined to "an individual addressing a body." The `[form]` slot of the headnote carries the variation, and a batch should spread across forms rather than repeat one: an op-ed or signed column in a newspaper (*"The following is an opinion column published in a regional newspaper, in which a [role] argues..."*), an unsigned editorial in the paper's own voice (*"The following is an editorial from a city newspaper on..."*), a first-person essay, a guest commentary, an open letter to a body, a witness account. The collective/institutional voice of an editorial takes no "speaker" persona line; it names the publication and occasion. Whatever the form, the headnote stays in the neutral third-person exam voice and names speaker-or-voice, audience, and occasion.
