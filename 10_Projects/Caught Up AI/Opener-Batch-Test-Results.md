...
> **Issue 2 correction (Samuel 2026-06-08):** stripping the parentheses was NOT enough. Remove ALL scholarly in-text citations entirely (named scholars/studies/journals inline too, e.g. "Carstensen's work", "NBER", "Portfolio studies do find") — AP Lang source articles do not carry in-text citations. Re-doing #12 and #24 as prose rewrites, not just regex strips. Permanent fix still to add to the pipeline. Issue 3 and the unspecified "article type" issue still open.
